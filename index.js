            ...
            const row = new Discord.MessageActionRow()
                .addComponents(
                    new Discord.MessageButton()
                        ...
                        .setLabel('Comprar')
                       .setEmoji('<:dinheiro:1062560638569807903>')
                        .setStyle('SUCCESS'),
                );
            ...
            interaction.guild.channels.create(`🛒・carrinho- ${interaction.user.username}`, {
               ...
               .addComponents(
                   new Discord.MessageButton()
                       .setCustomId('pix')
                       .setLabel("Aceitar")
                       .setEmoji("<:certo:1062561885238603836>")
                       .setStyle("SUCCESS"),
               )
                .addComponents(
                    new Discord.MessageButton()
                        ...
                        .setLabel("Recusar")
                        .setStyle("DANGER")
                        .setEmoji("<:errado:1062561914376437810>"),
                );
                            ...
                            const row = new Discord.MessageActionRow()
                                   .addComponents(
                                    new Discord.MessageButton()
                                        ...
                                        .setLabel("Cupom")
                                        .setEmoji('<:cupom:1064412099264131152>')
                                        .setStyle("PRIMARY"),
                                )
                                .addComponents(
                                    new Discord.MessageButton()
...
msg.channel.bulkDelete(50);
                                        ...
                                        mercadopago.payment.create(payment_data).then(function (data) {
                                            ...
                                            .addComponents(
                                                new Discord.MessageButton()
                                                    .setCustomId('qrcode')
                                                    .setEmoji('<:qrcode:1064412129907724338>')
                                                    .setLabel("QR Code")
                                                    .setDisabled(true)
                                                    .setStyle("PRIMARY"),
                                            )
                                                .addComponents(
                                                    new Discord.MessageButton()
                                                        .setCustomId('codigo')
                                                        .setEmoji('<:pixlogo:1064412141634998282>')
